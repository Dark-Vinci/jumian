            ...
            default: {
                const app = await core_1.NestFactory.createMicroservice(app_module_1.AppModule, {
                    ...
                    logger: nest_winston_1.WinstonModule.createLogger({
                        instance: (0, logger_1.initWinston)(sdk_1.RPCServiceName.SHOP),
                    }),
                });
                await app.listen();
                common_1.Logger.log(`Application running on url localhost:${3005}, on worker with pid: ${process_1.default.pid}`);
            }
        }
    }
}
...
Application.options = {
    url: sdk_1.RPCUrl.SHOP,
    package: sdk_1.RPCServiceName.SHOP,
    protoPath: (0, path_1.join)(__dirname, sdk_1.ProtoPath.SHOP),
    loader: {
        enums: String,
        objects: true,
        arrays: true,
